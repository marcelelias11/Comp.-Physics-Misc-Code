...
dados = read("arquivo_entrada_fced_20-03-2023.txt", 1,5)
g = dados(1); // gravidade
M1 = dados(2); // massa 1
M2 = dados(3); // massa 2
...
print("arquivo_saida_Vtheta1_fced_20-03-2023.txt", Vtheta1)
print("arquivo_saida_Vtheta2_fced_20-03-2023.txt", Vtheta2)
print("arquivo_saida_Vt_fced_20-03-2023.txt", Vt)
print("arquivo_saida_VK_fced_20-03-2023.txt", VK)
print("arquivo_saida_VU_fced_20-03-2023.txt", VU)
